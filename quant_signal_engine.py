        ...
        for trader in traders:
            ...
            self.conn.execute(
                ...
                (
                    snapshot_id,
                    wallet,
                    first_float(trader, ["pnl", "pnl_usd", "realized_pnl", "profit"]),
                    first_float(trader, ["volume", "volume_usd", "volumeUSD", "trade_volume"]),
                    first_int(trader, ["trade_count", "trades", "total_trades"]),
                    first_int(trader, ["buy_count", "buys"]),
                    first_int(trader, ["sell_count", "sells"]),
